...
bitfinex.onLesser("BTC", 3000, (symbol, event) => {
...
bitfinex.onPercentChange7d("ETH", 15, (symbol, event) => {
...
bitfinex.onPercentChange24h("ETH", -10, (symbol, event) => {
...
bitfinex.onPercentChange1h("LTC", 10, (symbol, event) => {
	console.log(symbol);
